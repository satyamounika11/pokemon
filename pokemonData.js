...
/* ------------------------------------------------------------------------------------------------------------------- */
// Display information of the pokemon

var pokemonData = function(name,pokemonList)
{
	...
	for(var x in pokemonList.pokemon)
	{
		...
		{
			pokemonName = true;
			console.log('Pokemon name = '+pokemonList.pokemon[x].name)
			console.log('Pokemon image = '+pokemonList.pokemon[x].img)
			console.log('Pokemon type = '+pokemonList.pokemon[x].type[0])
			console.log('Pokemon height = '+pokemonList.pokemon[x].height)
			console.log('Pokemon weight = '+pokemonList.pokemon[x].weight)
			console.log('Pokemon candy = '+pokemonList.pokemon[x].candy)
			console.log('Pokemon candy count = '+pokemonList.pokemon[x].candy_count)
			console.log('Pokemon egg = '+pokemonList.pokemon[x].egg)
			console.log('Pokemon spawn chance = '+pokemonList.pokemon[x].spawn_chance)
			console.log('Pokemon average spawns = '+pokemonList.pokemon[x].avg_spawns)
			console.log('Pokemon spawn time = '+pokemonList.pokemon[x].spawn_time)
			break						
		}		
	}
...
var name = window.prompt('enter pokemon name')
pokemonData(name,pokemonList)

/* ------------------------------------------------------------------------------------------------------------------------- */


// To find pokemon that have their name in the “next_evolution” field.

var nextEvolution = function(evolutionName,pokemonList)
{
	var pokeomonEvolutionName = false;
	for( x in pokemonList.pokemon)
	{
		for (y in pokemonList.pokemon[x].next_evolution)
	{
		if(pokemonList.pokemon[x].next_evolution[y].name == evolutionName)
		{
			pokeomonEvolutionName = true;
			console.log('Pokemon that have their name in the next_evolution field = '+pokemonList.pokemon[x].name)
			break
		}				
	}		
	}
	if(pokeomonEvolutionName == false)
	{
		console.log('Match not found')
	}
	else
...
var evolutionName = window.prompt('enter pokemon name')
nextEvolution(evolutionName,pokemonList)

/* -------------------------------------------------------------------------------------------------------------------------- */

// To find which pokemons have the given weaknesses

var pokemonWeakness = function(weakness,pokemonList)
{
	var similarPokemonWeakness = false;
	for(var x in pokemonList.pokemon)                                   
	{
		for (var y in pokemonList.pokemon[x].weaknesses)				
	{
		...
		{
			similarPokemonWeakness = true;								
			console.log('Pokemon having the same weakness =  '+pokemonList.pokemon[x].name)
			break
		}
	}		
	}																	
	if(similarPokemonWeakness == false)									
	{
		console.log('Match not Found')
	}
	else
...
pokemonWeakness(weakness,pokemonList)	
